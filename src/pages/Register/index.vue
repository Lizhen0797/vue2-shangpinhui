  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <span class="
               error-msg">{{ errors.first("phone") }}</span>
      </div>
      <div class="content">
        <label>验证码:</label>
      ...
      <div class="content">
        ...
        <span class="
               error-msg">{{ errors.first("confirmPassword") }}</span>
      </div>
      <div class="controls">
        <input type="checkbox"
               name="agree"
...
export default {
  ...
  methods: {
    ...
    async userRegister () {
      ...
      if (success) {
        try {
          await this.$store.dispatch('userRegister', { phone: this.phone, code: this.code, password: this.password })
